...
// Custom Imports
import { MultiValueChildrenProps, ValueChildrenProps } from "../../types/Modal";
...
const MultiValueModal: React.FC<MultiValueChildrenProps> = ({
  modalVisible,
  handleModalVisible,
  selectedValue,
  handleSelectedValue,
            ...
            </View>
            {
              dropDownData.map((i, k) => (
                <TouchableOpacity onPress={() => {
                  ...
                  {selectedValue && selectedValue.includes(i.value) && <FontAwesome name="dot-circle-o" size={24} color={colors.primaryGreen} />}
                </TouchableOpacity>
              ))
            }
          </ScrollView>
