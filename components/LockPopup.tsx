      ...
      <View className='bg-primaryLightGreen w-9/12 justify-center items-center h-40 px-6 rounded-md' style={{ gap: 10 }}>
        <Typography class='text-white text-center'>You're Signed Up !</Typography>
        {
          (role !== "agency-clinician" && userStatus !== "Active")
            ?
            <Typography variant='xsm' class='text-white text-center leading-5'>You're successfully signed up on Acta. While your account is under review for activation, you navigate to profile menu and complete your credentials.</Typography>
            :
