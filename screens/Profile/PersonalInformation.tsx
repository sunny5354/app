...
const PersonalInformation = ({ navigation }: { navigation: ScreenNavigationProp }) => {
  ...
  const [profReference1,setProfreference1] = useState({
    "name": "",
    "designation": "",
    "organization": "",
    "mobileNo": ""
  ...
  const [profReference2,setProfreference2] = useState({
    "name": "",
    "designation": "",
    "organization": "",
    "mobileNo": ""
  ...
  const fetchPersonalInfo = async () => {
    try {
      ...
      if(result.personal.primaryArea) {
        setPrimaryArea(result.personal.primaryArea);
      }
      
      if(result.personal.professionalReference1) {
        setProfreference1({
          name: result.personal.professionalReference1?.name,
          designation: result.personal.professionalReference1?.designation,
          organization: result.personal.professionalReference1?.organization,
          mobileNo: result.personal.professionalReference1?.mobileNo
        });
      }
      if(result.personal.professionalReference2) {
        setProfreference2({
          name: result.personal.professionalReference2?.name,
          designation: result.personal.professionalReference2?.designation,
          organization: result.personal.professionalReference2?.organization,
          mobileNo: result.personal.professionalReference2?.mobileNo
        });
      }
        ...
        <View className='flex-1' style={{ gap: 10 }}>
          ...
          <View className='h-16 flex-row justify-between items-center' style={{ gap: 20 }}>
            <Input label='Name'
              ...
              onChangeText={(val) => setProfreference1(prevState => ({ ...prevState,name: val}))}
              classView='flex-1'
            />
            <Input label='Designation'
              ...
              onChangeText={(val) => setProfreference1(prevState => ({ ...prevState,designation: val}))}
              classView='flex-1'
            />
           </View>
           <View className='h-16 flex-row justify-between items-center' style={{ gap: 20 }}>
            <Input label='Organization'
              ...
              onChangeText={(val) => setProfreference1(prevState => ({ ...prevState,organization: val}))}
              classView='flex-1'
            />
          ...
          <Typography>Professional Reference 2.</Typography>
           <View className='h-16 flex-row justify-between items-center' style={{ gap: 20 }}>
            <Input label='Name'
              ...
              onChangeText={(val) => setProfreference2(prevState => ({ ...prevState,name: val}))}
              classView='flex-1'
            />
            <Input label='Designation'
              placeholder='Enter Designation'
              value={profReference2?.designation}
              onChangeText={(val) => setProfreference2(prevState => ({ ...prevState,designation: val}))}
              classView='flex-1'
            />
           </View>
           <View className='h-16 flex-row justify-between items-center' style={{ gap: 20 }}>
            <Input label='Organization'
              ...
              onChangeText={(val) => setProfreference2(prevState => ({ ...prevState,organization: val}))}
              classView='flex-1'
            />
            <Input label='Mobile Number'
              placeholder='Enter Mobile Number'
