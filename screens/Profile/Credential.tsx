...
const Credential = () => {
  ...
  const [credentialType, setCredentialType] = useState({
    label: "Select Credential Type", value: "0"
  })
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values: FormValues) => {
      ...
      if (credentialType.value === "0") {
        infoToast("Please select Credential Type");
        return;
      }
      ...
      <ScrollView ref={scroll} className='p-4 bg-white flex-1' contentContainerStyle={{ paddingBottom: 120 }}>
        ...
        <View style={styles.backgroundShadow}>
          ...
          <Input
            ...
            classView='flex-1'
          />
          <MenuDropDown label='State*' selectedValue={selectedState} setSelectedValue={setSelectedState} data={statesData} />
